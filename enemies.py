...
class Blinky(Spirit):
    ...
    def __init__(self, grid, player_i, player_j):
        super().__init__('image/blinky.png', grid, player_i, player_j)


class Clyde(Spirit):

    def __init__(self, grid, player_i, player_j):
        super().__init__('image/clyde.png', grid, player_i, player_j)
...
class Inky(Spirit):
    ...
    def __init__(self, grid, player_i, player_j):
        super().__init__('image/inky.png', grid, player_i, player_j)
...
class Pinky(Spirit):
    ...
    def __init__(self, grid, player_i, player_j):
        super().__init__('image/pinky.png', grid, player_i, player_j)
